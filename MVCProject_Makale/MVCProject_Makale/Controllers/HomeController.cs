...
namespace MVCProject_Makale.Controllers
{
    ...
    public class HomeController : Controller
    {
        ...
        public ActionResult Index()
        {
            //int sayi = 1;
            //int sayi2 = 0;
            //int sayi3 = sayi / sayi2;   //error sayfasını denemek için yazdık
        ...
        public ActionResult Kategori(int? id)
        {
            ...
            List<Note> notes = ny.ListQueryable().Where(x => x.IsDraft == false && x.KategoriId == id).OrderByDescending(x => x.ModifiedDate).ToList();
